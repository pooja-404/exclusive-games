...
const Slots = () => {
    ...
    const card = cards.map((cards, i) => (<div key={i} className="lg:w-1/3 md:w-2/4  w-full px-3 flex justify-center group duration-500 mb-6">
        <div className='hover:bg-slot p-[1px] rounded-[8px] w-full'>
            <div className="lg:max-w-[364px] rounded-lg bg-[url(url(./assets/images/gline.webp)] w-full h-[265px] overflow-hidden relative bg-no-repeat bg-center bg-cover  bg-gradient p-[1px] " data-aos={`${cards.animation}`} data-aos-duration="1000" data-aos-offset="500"
    ...
    return (
        <div className="lg:mt-[150px] md:py-20 py-12">
            ...
            <div className='flex justify-center'>
                <button className='hover:shadow-[0_0_14px_9px_rgba(014,218,09,0.50)] duration-500 transition-all hover:scale-125 text-[#00141B] bg-gradient font-Inter font-bold text-base leading-[25px] p-[13px_46px_13px_46px] rounded-[41px] mt-5 relative after:absolute after:content-[url(./assets/images/gline.webp)] after:top-[31px] after:left-[-6px] '>Mostrar más</button>
            </div>
