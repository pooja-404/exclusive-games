...
const Footersec = () => {
    ...
    return (
        <div className="bg-[#000000] md:pb-5 pb-8 pt-10 relative z-10 ">
                ...
                <div className="flex flex-row flex-wrap -mx-3 md:pb-7">
                    ...
                    <div className="xl:w-7/12 px-3 pt-7 md:pt-10 w-full" data-aos="fade-up-left">
                        <div className="flex flex-row flex-wrap -mx-3">
                            <div className="md:w-4/12 w-1/2 px-3 flex lg:justi fy-end">
                                <ul>
                            ...
                            <div className="md:w-4/12 w-1/2 px-3 flex lg:justi fy-end">
                                <ul>
                                    ...
                                    <li className="flex gap-2 items-center pb-3 sm:pb-4 relative z-20">
                                        ...
                                        <a href="tel:+2349067322844" className="text-[#cccccc] text-base font-Inter leading-[25px] hover:text-[#ffff] transition-all duration-500">(101)342-7873</a>
                                    </li>
                                </ul>
                            </div>
